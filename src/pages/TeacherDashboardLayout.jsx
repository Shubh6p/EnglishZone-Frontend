...
import { GraduationCap, ChevronDown, LogOut, Menu, X, MoreVertical, Bell, Settings, Briefcase, Award } from 'lucide-react';
import './DashboardLayout.css'; // Reuse student panel structure styling for consistent spacing and response
...
const TeacherDashboardLayout = () => {
  ...
  // Redirect if not logged in or if role is not teacher
  useEffect(() => {
    if (!user) {
      navigate('/login');
    ...
    <div className="dashboard-layout-wrapper">
      ...
      <header className="dashboard-header">
        <div className="dash-header-left">
          ...
          <Link to="/teacher-dashboard" className="dash-logo">
          ...
          <div className="dropdown-container" ref={kebabRef}>
            ...
            {kebabOpen && (
              <div className="dropdown-menu kebab-dropdown scale-up">
                ...
                <button className="dropdown-item-btn" onClick={() => { setKebabOpen(false); alert("Teacher alert preferences updated."); }}>
                  <Bell size={16} />
                  <span>Notification Settings</span>
                </button>
                <button className="dropdown-item-btn" onClick={() => { setKebabOpen(false); alert("Schedule sync configured."); }}>
                  <Settings size={16} />
            ...
            {profileOpen && (
              <div className="dropdown-menu profile-dropdown scale-up">
                ...
                <div className="profile-drop-details">
                  <p className="profile-detail-line"><strong>Subject:</strong> {user.subject}</p>
      ...
      {showNotificationModal && (
        <div className="modal-overlay fade-in">
          <div className="modal-content scale-up">
            ...
            <p className="modal-subheading-text">Administrative notifications for faculty member Mrs. Anjali Sen.</p>
            
            <div className="notifications-list">
              <div className="notification-card-item unread">
                <span className="notif-badge bg-primary">Administration</span>
                <div className="notif-text-content">
                  <h4>Unit Test II Roster Submission</h4>
                  <p>Attendance rosters for Grade 10-A should be submitted before June 20. Ensure all absences are logged.</p>
                  <span className="notif-time">1 hour ago</span>
                </div>
              </div>
              <div className="notification-card-item unread">
                <span className="notif-badge bg-accent">Payroll</span>
                <div className="notif-text-content">
                  <h4>June Payroll Processing</h4>
                  <p>June salary slips are now available for review under the Payroll section. Please verify leaves deductions.</p>
                  <span className="notif-time">1 day ago</span>
                </div>
              </div>
              <div className="notification-card-item">
                <span className="notif-badge bg-success">System</span>
                <div className="notif-text-content">
                  <h4>NCERT Books Updated</h4>
                  <p>Latest supplementary readers for Class 10 supplementary English text have been synced into Curriculum resources.</p>
